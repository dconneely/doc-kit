...
A formatting-only edit MUST NOT change a word, only whitespace, list markers, or other
rendering-only tokens, and remains ordinary reviewed work like any other change to the tree.
