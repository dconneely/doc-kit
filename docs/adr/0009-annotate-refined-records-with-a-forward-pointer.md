...
* Add a fifth status *value* for refined records
...
**Refinement must not change the decision.** If the *Decision Outcome* stopped being true, that is
...
* Bad, because the distinction between refining and superseding is a judgement call and will
  sometimes be got wrong. The test is narrow enough to apply honestly: did the *Decision Outcome*
  stop being true?
