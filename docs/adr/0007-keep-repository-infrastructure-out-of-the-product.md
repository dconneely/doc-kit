...
configure _itself_. A `.gitattributes` today; plausibly a pre-commit configuration, CI workflows and
...
scripts are the obvious candidate, with CI workflow examples behind them. Nothing here forecloses
