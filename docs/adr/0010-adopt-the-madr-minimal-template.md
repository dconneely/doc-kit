...
`decision-makers` records _who_ decided - the thing ADR-0008 wants and currently leaves to review.
...
alternative. Front-matter alone was rejected because it would leave the section names non-standard -
the half-measure that made the original claim inaccurate.
