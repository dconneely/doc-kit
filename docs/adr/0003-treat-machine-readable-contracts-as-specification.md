...
distinguishes it except the medium, and being machine-checked makes it _better_ specification, not
...
- Good, because ordered migrations come out changelog-shaped rather than specification, whatever
  they describe - the specification is the _current_ shape, which is why a generated snapshot of it
