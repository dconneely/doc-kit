...
**Map** - `DOC-MAP.md`. Names every artifact, what each is for, and where a given fact belongs. The
entry point, and the thing that must never promise a file that does not exist.
